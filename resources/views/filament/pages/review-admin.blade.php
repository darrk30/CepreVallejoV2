<x-filament-panels::page>
    <style>
        ...
        .dark .ra-search-icon { color: #636086; }
        .ra-search-input {
            width: 100%;
            border-radius: 14px;
        ...
        .ra-search-input::placeholder { color: #8b88b0; }
        ...
        .dark .ra-search-input::placeholder { color: #636086; }
        ...
        .ra-table thead tr { border-bottom: 1px solid rgba(99,102,241,0.12); }
        .dark .ra-table thead tr { border-bottom-color: rgba(129,140,248,0.10); }
        .ra-table th {
            padding: 12px 20px;
            text-align: left;
            font-size: 0.68rem;
        ...
        .dark .ra-table th { color: #636086; }
        .ra-table td {
            padding: 14px 20px;
            border-bottom: 1px solid rgba(99,102,241,0.08);
        }
        .dark .ra-table td { border-bottom-color: rgba(129,140,248,0.08); }
        .ra-table tbody tr {
            cursor: pointer;
            transition: background-color 0.15s;
        }
        .ra-table tbody tr:hover { background: #f9f8ff; }
        .dark .ra-table tbody tr:hover { background: #1b1a2e; }
        .ra-td-name {
            font-size: 0.85rem;
            font-weight: 700;
            color: #0c0b1a;
        }
        .dark .ra-td-name { color: #edecf8; }
        .ra-td-msg {
            font-size: 0.82rem;
            font-style: italic;
            color: #5b5875;
        }
        .dark .ra-td-msg { color: #9d9ac2; }
        .ra-td-date {
            font-size: 0.78rem;
            color: #a5a2c4;
        }
        .dark .ra-td-date { color: #54506e; }
        .ra-col-date { display: table-cell; }
        @media (max-width: 640px) {
            .ra-col-date { display: none; }
        }
        .ra-empty {
            padding: 60px 20px;
            text-align: center;
        ...
        .ra-badge-dot { width: 6px; height: 6px; border-radius: 999px; }
        .ra-badge-activo { background: rgba(16,185,129,0.10); color: #059669; }
        .dark .ra-badge-activo { color: #34d399; }
        .ra-badge-activo .ra-badge-dot { background: #10b981; }
        .ra-badge-eliminado { background: rgba(239,68,68,0.10); color: #ef4444; }
        .ra-badge-eliminado .ra-badge-dot { background: #ef4444; }

        /* PAGINATION */
        .ra-pagination { margin-top: 24px; display: flex; justify-content: center; }
        ...
        .dark .ra-modal-box { background: #151424 !important; }
        ...
        .dark .ra-modal-header { border-bottom-color: rgba(129,140,248,0.12); }
        .ra-modal-eyebrow {
            margin: 0 0 4px 0;
            font-size: 0.62rem;
            font-weight: 700;
        ...
        .dark .ra-modal-eyebrow { color: #818cf8; }
        .ra-modal-title {
            margin: 0;
            font-size: 1.1rem;
            font-weight: 800;
        ...
        .dark .ra-modal-title { color: #edecf8; }
        .ra-modal-close {
            display: flex;
            flex-shrink: 0;
        ...
        .ra-modal-close:hover { background: rgba(91,94,244,0.10); color: #5b5ef4; }
        .dark .ra-modal-close { color: #636086; }
        .dark .ra-modal-close:hover { background: rgba(129,140,248,0.10); color: #818cf8; }

        .ra-modal-body { padding: 20px 28px; overflow-y: auto; flex: 1 1 auto; }
        .ra-modal-text {
            margin: 0;
        ...
        .dark .ra-modal-text { color: #c1bee0; }
        ...
        .dark .ra-modal-footer { border-top-color: rgba(129,140,248,0.12); background: #1b1a2e; }
        .ra-modal-meta { display: flex; align-items: center; gap: 12px; }
        .ra-modal-date {
            display: inline-flex;
            align-items: center;
            gap: 6px;
        ...
        .dark .ra-modal-date { color: #54506e; }
        .ra-modal-status { font-size: 0.68rem; font-weight: 700; }
        .ra-modal-status-activo { color: #059669; }
        .ra-modal-status-eliminado { color: #ef4444; }
        .ra-modal-close-btn {
            border: none;
            border-radius: 999px;
            background: #5b5ef4;
        ...
        .ra-modal-close-btn:hover { background: #4b4ee0; }
        .dark .ra-modal-close-btn { background: #818cf8; }
        .dark .ra-modal-close-btn:hover { background: #6f78f0; }
    </style>

    <div class="ra-wrap"
         x-data="{ modalAbierto: false, modalAlumno: '', modalTexto: '', modalFecha: '', modalEstado: '' }"
        ...
        <div class="ra-toolbar">
            <div class="ra-search-box">
                ...
                <input type="text" class="ra-search-input"
                    ...
                    @forelse ($this->getReviews() as $review)
                        ...
                        <tr wire:key="admin-review-{{ $review->id }}"
                            @click="modalAbierto = true;
                                    ...
                                    modalTexto = {{ \Illuminate\Support\Js::from($mensajeTexto) }};
                            ...
                            <td>
                                <span class="ra-badge {{ $review->estado === 'activo' ? 'ra-badge-activo' : 'ra-badge-eliminado' }}">
            ...
            <div x-show="modalAbierto" x-cloak class="ra-modal-overlay" @click.self="modalAbierto = false">
                <div x-show="modalAbierto"
                    ...
                    <div class="ra-modal-body">
                        <p class="ra-modal-text" x-text="modalTexto"></p>
                    </div>
