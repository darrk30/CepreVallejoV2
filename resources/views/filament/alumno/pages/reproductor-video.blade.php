        ...
        <div class="vp-layout">
            ...
            <div>
                <div class="vp-player-wrap">
                    <iframe src="{{ $this->getEmbedUrl($tuVariableDeUrl) }}" frameborder="0"
                ...
                <div class="vp-info">
                    ...
                    <div class="vp-meta">
                        ...
                        <span class="vp-meta-item">
                            <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M4.26 10.147a60.438 60.438 0 00-.491 6.347A48.62 48.62 0 0112 20.904a48.62 48.62 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.636 50.636 0 00-2.658-.813A59.906 59.906 0 0112 3.493a59.903 59.903 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0112 13.489a50.702 50.702 0 013.741-1.234" />
                            </svg>
                ...
                @foreach ($this->recommended_videos as $i => $rec)
                    ...
                    <a href="{{ \App\Filament\Alumno\Pages\ReproductorVideo::getUrl(['videoSlug' => $rec->slug]) }}"
                        ...
                        <div class="rec-thumb-wrap">
                            @if ($recThumb)
                                <img src="{{ $recThumb }}" class="rec-thumb-img" alt="{{ $rec->titulo }}"
                                    loading="lazy">
                            @else
                                <div
                                    style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:var(--surface3);">
                                    <svg style="width:20px;height:20px;color:var(--muted);" fill="none"
