...
<x-filament-panels::page>
    <div class="aula">
        @if ($this->assignmentId)
                                            ...
                                            <div class="detail-resources">
                                                ...
                                                @if ($detail->archivo_path)
                                                    <a href="{{ Storage::url($detail->archivo_path) }}"
                                                        download="{{ basename($detail->archivo_path) }}"
                                                        target="_blank" class="res-file"
                                                ...
                                                @if ($detail->url_video)
                                                    <button class="res-video" @click="openVideo = !openVideo">
                                                        ...
                                                        <span
                                                            x-text="openVideo ? 'Ocultar video' : 'Ver video'"></span>
                                                    </button>
                                                @endif
                                        ...
                                        <div class="aula-actions-mobile" style="padding-top:1px;">
                                            ...
                                            <div class="dropdown-menu" id="det-drop-{{ $detail->id }}">
                                                ...
                                                @can($detailExam ? 'update_exam' : 'create_exam')
                                                    ...
                                                    <button
                                                        class="dropdown-item {{ $detailExam ? 'item-edit' : 'item-add' }}"
            ...
            @endif
        @else
            {{-- Mensaje cuando no hay profesor asignado --}}
            <div class="no-teacher-container">
                <div class="no-teacher-content">
                    <div class="no-teacher-icon-wrapper">
                        <svg class="no-teacher-icon" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <h2 class="no-teacher-title">Curso sin profesor asignado</h2>

                    <p class="no-teacher-text">
                        Actualmente no hay un docente vinculado a este curso en el ciclo académico seleccionado.
